    ...
    public class Repository : IRepository 
    {
        ...
        public async Task<PageList<Aluno>> GetAllAlunosAsync(PageParams pageParams, bool includeProfessor = false)
        {
            ...
            if (!string.IsNullOrEmpty(pageParams.Nome))
                ...
                .ToUpper().Contains(pageParams.Nome.ToUpper()) || aluno.Sobrenome
        ...
        public Aluno[] GetAllAlunosByDisciplinaId(int disciplinaId, bool includeProfessor = false)
        {
            ...
            query = query.AsNoTracking().OrderBy(a => a.Id).Where(aluno => aluno.AlunosDisciplinas
        ...
        public Professor[] GetAllProfessoresByDisciplinaId(int disciplinaId, bool includeAlunos = false)
        {
            ...
            query = query.AsNoTracking().OrderBy(a => a.Id).Where(aluno => aluno.Disciplinas
             .Any(d => d.AlunosDisciplinas.Any(ad => ad.DisciplinaId == disciplinaId)));
