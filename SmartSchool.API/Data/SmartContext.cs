        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Professor>()
                .HasData(new List<Professor>(){
                    new Professor(1,1, "Lauro" , "Maduro"),
                    new Professor(2,2, "Roberto" , "noia"),
                    new Professor(3,3, "Ronaldo" , "Soraia"),
                    new Professor(4,4, "Rodrigo" , "gay"),
                    new Professor(5,5, "Alexandre", "Bicha"),
                });

            builder.Entity<Curso>()
                .HasData(new List<Curso>{
                    new Curso(1, "Tecnologia da informação"),
                    new Curso(2, "Ciencias da Computação"),
                    new Curso(3, "Engenharia de software"),
                });
